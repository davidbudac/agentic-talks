...
public final class Report {
     ...
     * same line. Entries are ordered by customer, ignoring case and accents
     * ({@link CustomerNames#comparator()}), then by currency code. If {@code currency} is
     * not null, other currencies are left out.
     */
    public static List<Entry> summarise(List<Invoice> invoices, String currency) {
        ...
        entries.sort(Comparator.comparing(Entry::customerName, CustomerNames.comparator())
