 ...
 * @param customerName customer name as written (see {@link CustomerNames} for comparing names)
 ...
 */
public record Invoice(String id, String customerName, BigDecimal net, BigDecimal taxRate,
