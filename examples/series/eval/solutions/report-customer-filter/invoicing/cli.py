...
def _report(args) -> str:
    return build_report(load_invoices(args.file), currency=args.currency, customer=args.customer)
...
def build_parser() -> argparse.ArgumentParser:
    ...
    report.add_argument("--customer", help="only customers whose name contains this text")
