...
| Toolbox: supplied documents and audio | [Gemini Notebook](https://notebook.google/), [Google's Audio Overviews announcement](https://blog.google/innovation-and-ai/products/notebooklm-audio-overviews/) | The original NotebookLM URL redirects to the current Gemini Notebook page; the historical Google announcement explains Audio Overviews based on supplied sources. |
...
| Toolbox: shop experiment | [Project Vend, phase 1](https://www.anthropic.com/research/project-vend-1) | June 2025 report: supplier research and stock changes, but below-cost sales and invented payment details. We do not claim literal bankruptcy or generalise to all agents. |
...
- The loop and subagent videos are retained Remotion assets. Their production source is `remotion/src/`; static posters are new SVG diagrams. No new video was represented as a vendor-generated result.
